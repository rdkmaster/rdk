define('main', ['application', 'blockUI','rd.controls.BasicSelector','rd.controls.Selector',
  ...
  'rd.containers.Tab','rd.controls.Map','rd.controls.Bullet','rd.controls.SingleIndicator','rd.controls.ProgressBar'],
...
// 创建一个控制器
app.controller('rdk_ctrl', ['$scope' ,'DataSourceService', 'blockUI','EventService','EventTypes','ProgressbarFactory',
function(scope,DSService, blockUI,EventService,EventTypes,ProgressbarFactory) {
...
scope.start=function(){
  ...
  var progress=document.getElementById("ngProgress");
  scope.width=progress.style.width;
