define('main', ['application', 'blockUI','rd.controls.BasicSelector','rd.controls.Selector',
  ...
  'rd.containers.Tab','rd.controls.Map','rd.controls.Bullet','rd.controls.SingleIndicator'],
...
scope.label="Apple";
scope.pointTo="right";
scope.pointToLeft=function(){
  scope.pointTo="left";
}
scope.pointToTop=function(){
  scope.pointTo="top";
}
scope.pointToRight=function(){
  scope.pointTo="right";
}
scope.pointToBottom=function(){
