                                                            ...
                                                            if (ch == "&") {
                                                                ...
                                                                if (stream.current().match(/http|https/) != null) {
                                                                    ...
                                                                    if (stream.peek() == "<" || stream.peek() == ">") {
                                                                        ...
                                                                        if (stream.peek().match(/\(/) != null) {
                                                                            return ret(null, ch)
                                                                        } else {
                                                                            if (stream.peek() == "/" && state.stack[state.stack.length - 1] != undefined) {
                                                                                return ret("string", "string")
                                                                            } else {
                                                                                if (stream.current().match(/\-\d|\-.\d/)) {
                                                                                    return ret("number", "unit")
                                                                                } else {
                                                                                    if (inTagsArray(stream.current())) {
                                                                                        return ret("tag", "tag")
                                                                                    } else {
                                                                                        if (/\/|[\s\)]/.test(stream.peek() || stream.eol() || (stream.eatSpace() && stream.peek() == "/")) && stream.current().indexOf(".") !== -1) {
                                                                                            if (stream.current().substring(stream.current().length - 1, stream.current().length) == "{") {
                                                                                                stream.backUp(1);
                                                                                                return ret("tag", "tag")
                                                                                            }
                                                                                            if ((stream.eatSpace() && stream.peek().match(/[{<>.a-zA-Z]/) != null) || stream.eol()) {
                                                                                                return ret("tag", "tag")
                                                                                            }
                                                                                            return ret("string", "string")
                                                                                        } else {
                ...
                if (style == "variable") {
                    if (context == "rule") {
                        ...
                        if (!context || context == "@media{") {
                            style = stream.current() == "when" ? "variable": stream.string.match(/#/g) != undefined ? null: /[\s,|\s\)]/.test(stream.peek()) ? "tag": null
                        }
                    }
                }
            }
