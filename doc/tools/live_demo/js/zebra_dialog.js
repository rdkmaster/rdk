    ...
    c.Zebra_Dialog = function(g, j) {
        ...
        a.init = function() {
            ...
            if (a.settings.modal) {
                ...
                a.settings.overlay_close && a.overlay.bind("click",
                function() {
                    a.close()
                });
            ...
            var b = parseInt(a.settings.width); ! isNaN(b) && b == a.settings.width && b.toString() == a.settings.width.toString() && b > 0 && a.dialog.css({
                ...
                function(b, e) {
                    ...
                    function() {
                        ...
                        if (void 0 != e.callback) {
                            rv = e.callback(a.dialog, a)
                        }
                        if (typeof rv == "undefined" || rv) {
                            a.close(void 0 != e.caption ? e.caption: e)
                        }
                    });
                    if (typeof e.enter != "undefined" && e.enter) {
                        a.dialog.keydown(function(event) {
                            if (event.keyCode == 13) {
                                h.click();
