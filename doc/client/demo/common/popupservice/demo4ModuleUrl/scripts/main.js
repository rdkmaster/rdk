...
require.config({
    paths: {
        ...
        "sample_module": '/doc/client/demo/common/popupservice/demo4ModuleUrl/template/sample_module'
    }
});
...
define('main', ['rd.controls.Module', 'rd.services.PopupService', 'sample_module'], function() {
    ...
    rdk.$ngModule.controller('rdk_ctrl', ['$scope', 'Utils', '$compile', 'PopupService', function(scope, Utils, $compile, PopupService) {
        ...
        scope.load = function(){
            var sampleUrl = '/doc/client/demo/common/popupservice/demo4ModuleUrl/template/sample_module.html';
