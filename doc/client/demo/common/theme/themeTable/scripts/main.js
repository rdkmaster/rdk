define('main', ['rd.controls.Table',"rd.attributes.theme",'rd.containers.Panel'], function() {
    // 创建一个RDK的应用
    var app = angular.module("rdk_app", ['rd.controls.Table','rd.core',"rd.attributes.theme",'rd.containers.Panel']);
    // 创建一个控制器
