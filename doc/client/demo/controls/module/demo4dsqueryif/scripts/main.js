...
require.config({
    paths: {
        ...
        "sample_module": '/doc/client/demo/controls/module/demo4dsqueryif/template/sample_module'
    }
});
...
define('main', ['rd.controls.Module', 'sample_module', 'rd.controls.Table', 'rd.attributes.ds'], function() {
