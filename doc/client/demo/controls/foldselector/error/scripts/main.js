define('main', ['rd.controls.FoldSelector','rd.controls.BasicSelector','rd.containers.Accordion'], function() {

    // 创建一个RDK的应用
    var app = angular.module("rdk_app", ['rd.controls.FoldSelector','rd.controls.BasicSelector','rd.containers.Accordion']);
    // 创建一个控制器
