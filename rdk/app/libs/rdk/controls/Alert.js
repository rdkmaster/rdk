define(['angular'], function() {
    ...
    dsModule.controller('rdkAlert', ['$scope', function($scope) {
            ...
            $scope.closeFrame = function() {
                $('.rdk-alert-alertFrame').css('display', 'none');
            };
        }])
        .directive('rdkAlert', function() {
            return {
                ...
                replace: true,
                controller: 'rdkAlert',
                template: '<div class="rdk-alert-alertFrame" style="height: 173px;width: 508px;margin: 20px 0 0 20px;border: 1px solid grey;border-radius: 5px;z-index:-1000">' +
