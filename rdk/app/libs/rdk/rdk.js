rdk = (function() {
    ...
    function _setupLoading() {
        ...
        if (oLoading) {
            ...
            var gifBase64 = 'R0lGODlhPAA8AOZOACqa0n7ZOw6NzG3UIVSu25fhYQyMzGvUH7HoiX/C5OLx+TKe1KrmfpjO6bvr' +
            ...
            loading = '<div class="rdk-loader"><img src="data:image/gif;base64, ' + gifBase64 +
                '" alt="loading..." style="width: 60px;height: 60px" /></div>';
        }
