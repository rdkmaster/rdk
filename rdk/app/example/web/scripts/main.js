(function() {
    ...
    function main(scope, DataSourceService, EventService) {
        ...
        // 上面的变量/函数，都是全局变量，这会给后续代码维护带来各种不必要的麻烦。
        // 请记住，一个全局变量就是一个坑！变量的作用范围越小越好。
        // 
        // scope 在Angular中非常复杂，但它的使用原则却是难以置信的简单，记住一点就够了：
        // 凡是在html中用到的变量/函数都要定义在 scope 上，否则就不要将变量/函数定义在 scope 上
        //
