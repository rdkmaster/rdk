    ...
    describe("RdkUtilTest Unit ")  {
      ...
      describe("check pass function handleJsRequest()"){
        ...
        it("script return string type"){
          RdkUtil.handleJsRequest(runtime,null,ConstForTest.testRelayFilePath+"testForhandleJsRequest_returnStr.js",null,null,"get") should be ("return string")
        }

        it("script return obj type"){
          RdkUtil.handleJsRequest(runtime,null,ConstForTest.testRelayFilePath+"testForhandleJsRequest_returnObj.js",null,null,"get") should be (s"""{"head":"header","body":"message"}""")
        }

        it("callable defined post"){
          RdkUtil.handleJsRequest(runtime,null,ConstForTest.testRelayFilePath+"testForhandleJsRequest_callableDefined_post.js",null,null,"post") should be ("return post function")
        }

        it("callable defined delete"){
          RdkUtil.handleJsRequest(runtime,null,ConstForTest.testRelayFilePath+"testForhandleJsRequest_callableDefined_delete.js",null,null,"delete") should be ("return delete function")
        }

        it("callable defined put"){
          RdkUtil.handleJsRequest(runtime,null,ConstForTest.testRelayFilePath+"testForhandleJsRequest_callableDefined_put.js",null,null,"put") should be ("return put function")
        }
      }
